...
function Show(props) {
    ...
    useEffect(() => {
        fetch('http://backend.test/api/visitors', {
            method: "GET",
            headers: {
        ...
        fetch('http://backend.test/api/tickets', {
            method: "GET",
            headers: {
                'Content-type': 'application/json',
            },
    ...
    <React.Fragment>
            ...
            <tbody>
                {visitorTable.map(item => {
                    return (
                        ...
                        <td>{item.ticketid}</td>
                        <td><button onClick={() => {
                            fetch('http://backend.test/api/visitors/'+item.id, {
                                method: "DELETE",
                                headers: {
                                    'Content-type': 'application/json',
                                }}).then((response) => response.json()).then((data) => setVisitors([...data.visitors]))
        ...
        <br />
        <button onClick={() => {
            fetch('http://backend.test/api/visitors/'+visitorUpdateID, {
                method: "PUT",
                headers: {
                    'Content-type': 'application/json',
                },
            ...
            <tbody>
                {ticketTable.map(item => {
                    return (
                        ...
                        <td>{item.maxUse}</td>
                        <td><button onClick={() => {
                            fetch('http://backend.test/api/tickets/'+item.id, {
                                method: "DELETE",
                                headers: {
                                    'Content-type': 'application/json',
                                }}).then((response) => response.json()).then((data) => setTickets([...data.tickets]))
        ...
        <br/>
        <button onClick={() => {
            fetch('http://backend.test/api/tickets/'+ticketIDUpdate, {
                method: "PUT",
                headers: {
                    'Content-type': 'application/json',
                },
